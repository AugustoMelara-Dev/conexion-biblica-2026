            ...
            <Card key={report.id} className="shadow-none">
              <CardHeader className="flex flex-col justify-between gap-3 sm:flex-row sm:items-start">
                ...
                <div className="flex gap-2">
                  <Badge variant="outline">{report.question.bankProfileId === "prep-v3" ? "V3" : report.question.bankProfileId === "master-v2" ? "V2" : report.question.bankProfileId === "curated-v4" ? "V4" : "V1"}</Badge>
