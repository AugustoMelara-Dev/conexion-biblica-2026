...
export const MASSIVE_TRAINING_MODES: MassiveTrainingMode[] = [
  ...
  { id: "expert-multiple-choice", label: "Selección directa experta", description: "Cuatro opciones cercanas y una respuesta exacta.", group: "precisión", count: 100, sourceWorks: ALL_WORKS, chapters: [], types: ["single_choice"], difficultyBands: ["EXPERT"], statuses: ["all"], includeBlind: false, perQuestionSeconds: 12 },
