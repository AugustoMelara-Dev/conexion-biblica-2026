...
export const MASSIVE_TRAINING_MODES: MassiveTrainingMode[] = [
  ...
  { id: "expert-true-false", label: "Verdadero/Falso competitivo", description: "Cien detalles medios, difíciles o expertos alterados bajo presión.", group: "precisión", count: 100, sourceWorks: ALL_WORKS, chapters: [], types: ["true_false"], difficultyBands: ["MEDIUM", "HARD", "EXPERT"], statuses: ["all"], includeBlind: false, perQuestionSeconds: 8 },
  { id: "expert-multiple-choice", label: "Selección única competitiva", description: "Cien preguntas difíciles o expertas con opciones cercanas.", group: "precisión", count: 100, sourceWorks: ALL_WORKS, chapters: [], types: ["single_choice"], difficultyBands: ["HARD", "EXPERT"], statuses: ["all"], includeBlind: false, perQuestionSeconds: 12 },
